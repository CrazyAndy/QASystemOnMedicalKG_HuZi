...
class ChatBotGraph:
    ...
    def chat_main(self, question):
        ...
        diseases_from_chroma, symptoms_from_chroma, drugs_from_chroma = query_data_from_chroma(
            json.loads(data))
        ...
        diseases, disease_names = query_disease_by_symptom(
            symptoms_from_chroma)
        ...
        summary = llm_summary(question, diseases, disease_names, drug_names)
